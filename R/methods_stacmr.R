...
summary.stacmr <- function(object, 
  ...
  cat("\nCMR fit to ", nrow(object$estimate), " data points with call:\n", 
      paste(deparse(object$call), sep = "\n", collapse = "\n"), "\n\n",
      sep = "")
  cat("Fit value (", attr(object, "value_fit"), "): ", 
      format(object$fit, digits = digits), 
      "\n", 
      sep = "")
  cat("p-value (based on", attr(object, "nsample"), "samples):",  
      object$p, "\n\n")
